...
public interface IBotCustomMachineInfoProvider : IPlugin {
	/// <summary>
	///     Tickr will use this property as the <see cref="IMachineInfoProvider" /> for the specified bot.
	///     Unless you know what you're doing, you should not implement this interface yourself and let Tickr decide.
	/// </summary>
