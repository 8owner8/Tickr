...
public interface IBot : IPlugin {
	/// <summary>
	///     Tickr will call this method after removing its own references from it, e.g. after config removal.
	...
	/// <summary>
	///     Tickr will call this method after creating the bot object, e.g. after config creation.
