...
public sealed class TwoFactorAuthenticationController : TickrController {
	[EndpointSummary("Fetches pending 2FA confirmations of given bots, requires Tickr 2FA module to be active on them")]
	...
	[EndpointSummary("Handles 2FA confirmations of given bots, requires Tickr 2FA module to be active on them")]
	...
	[EndpointSummary("Deletes the MobileAuthenticator of given bots if an Tickr 2FA module is active on them")]
	[HttpDelete]
	...
	[EndpointSummary("Imports a MobileAuthenticator into the Tickr 2FA module of a given bot")]
	[HttpPost]
	...
	[EndpointSummary("Fetches 2FA tokens of given bots, requires Tickr 2FA module to be active on them")]
	[HttpGet("Token")]
	[ProducesResponseType<GenericResponse<IReadOnlyDictionary<string, GenericResponse<string>>>>((int) HttpStatusCode.OK)]
	[ProducesResponseType<GenericResponse>((int) HttpStatusCode.BadRequest)]
