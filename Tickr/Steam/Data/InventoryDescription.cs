					...
					case "DROPRATE":
						switch (tag.internal_name) {
							...
							case "droprate_2":
								...
								return CachedRarity.Value;
							default:
								TickrApp.TickrLogger.LogGenericError(Strings.FormatWarningUnknownValuePleaseReport(nameof(tag.internal_name), tag.internal_name));
				...
				switch (tag.category) {
					case "Game":
						...
						if (!uint.TryParse(appIDText, out uint appID) || (appID == 0)) {
							TickrApp.TickrLogger.LogNullError(appID);
